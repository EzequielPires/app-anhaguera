...
class CardSolicitation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Text(solicitation.type!.name, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600),),
          const Divider(),
          Row(
            children: [
              const Text('Protocolo:', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600),),
              const SizedBox(
                width: 8,
              ),
          ...
          Row(
            ...
            children: [
              const Text('Endereço:', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600),),
              const SizedBox(
                width: 8,
              ),
              Expanded(
          ...
          Row(
            children: [
              const Text('Solicitante:', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600),),
              const SizedBox(
                width: 8,
              ),
